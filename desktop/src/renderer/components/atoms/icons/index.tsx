...
export const ZVSLogoIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
    <path d="M17.823 10.985c-.356-.162-.723-.298-1.087-.442a196 196 0 0 0-2.931 4.792 80 80 0 0 0-1.162 2.035c-.029.055-.03.054-.1-.07-.132-.235-.242-.424-.377-.657-.526-.003-1.124-.008-1.632-.002.111.213 2.037 3.802 2.091 3.803a378 378 0 0 0 5.198-9.459m-4.245 4.25c-2.83-.059-5.662-.03-8.492-.084 2.4-3.508 4.818-7.006 7.196-10.53 0-.029-9.727-.024-9.727-.008 0 .007.033.057.073.111.985 1.423 2.187 2.684 3.164 4.112h1.282c-.101-.193-2.397-3.065-2.489-3.222-.013-.024.576-.03 2.914-.03 1.612 0 2.931.009 2.93.018 0 .01-.092.144-.206.299s-.376.518-.582.809a346 346 0 0 1-1.335 1.863c-.118.165-.942 1.31-1.392 1.933-1.389 1.943-2.796 3.871-4.172 5.823 0 .008 2.255.02 5.011.013l5.136-.011c.222-.366.429-.741.638-1.115zm5.326 1.054q1.889-.35 2.409-2.08c.12-.401.144-.571.144-1.03 0-.458-.028-.631-.168-1.055-.255-.777-.75-1.4-1.507-1.899-.299-.196-1.12-.596-1.852-.901-.773-.323-.855-.36-1.294-.576-1-.494-1.46-.987-1.565-1.675-.07-.454.052-.954.324-1.334a1.7 1.7 0 0 1 .671-.552c.509-.249 1.152-.308 1.911-.177.339.06.845.21 1.036.308l.063.032-.16.393-.256.625a3 3 0 0 0-.09.237 19 19 0 0 0 1.011.522c.004-.004.078-.176.165-.382l.259-.61c.231-.54.55-1.297.594-1.41l.048-.121-.216-.113a6.2 6.2 0 0 0-2.126-.698 7.6 7.6 0 0 0-1.418-.038c-1.676.17-2.829 1.13-3.068 2.554-.06.351-.05.836.022 1.193.165.815.6 1.438 1.384 1.982.443.307.857.517 1.932.976 1.503.642 2.067.966 2.445 1.404.204.237.359.556.425.877.076.371.03.988-.098 1.312-.252.638-.87 1.025-1.785 1.117a22 22 0 0 1-1.198.024l-1.054-.004c-.223.373-.43.755-.638 1.137 0 .007.85.014 1.768.01 1.433-.008 1.7-.014 1.882-.048m-7.794-1.372c0-.015-2.592-4.267-2.607-4.245-.273.395-.536.797-.803 1.196.575.956 1.254 2.105 1.847 3.05.037.024 1.563.023 1.563 0" />
  </FilledIcon>
);
export const OllamaIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
...
export const CheckIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
    <path d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z" />
  </FilledIcon>
);
export const BlockIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
...
export const FileClockIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
...
export const OpenInNewIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
    <path d="M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z" />
  </FilledIcon>
);
export const PaletteIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
...
export const GitlabIcon: SvgIcon = (props) => (
  <FilledIcon {...props}>
